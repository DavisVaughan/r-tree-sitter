...
[![Codecov test coverage](https://codecov.io/gh/DavisVaughan/r-tree-sitter/branch/main/graph/badge.svg)](https://app.codecov.io/gh/DavisVaughan/r-tree-sitter?branch=main)
<!-- badges: end -->
...
This package does _not_ provide bindings to a language specific tree-sitter _grammar_. To fully utilize the treesitter package, you will also need to install a grammar specific R package. Currently there is just one, for R:
